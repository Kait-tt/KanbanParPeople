...
var updatedDetailParams = require('../../fixture/updatedDetailIssue');
    ...
    describe('github', function () {
        describe('#updateDetailIssue', function () {
            ...
            it('titleとbodyが修正できる', function (done) {
                github.updateDetailIssue(config.repo, config.user, targetIssue, updatedDetailParams, function (err, data) {
