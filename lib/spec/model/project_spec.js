...
describe('model', function () {
    describe('project', function () {
        ...
        describe('update priority', function () {
            describe('with moving first to second (i.e. swapping first for second)', function () {
                var oldIssueTitles;
                beforeEach(function (done) {
                    oldIssueTitles = _.pluck(project.issues, 'title');
                    project.updateIssuePriority(project.issues[0]._id, 1, ew(function () { reFindProject(done); }));
                });
            ...
            describe('with moving third to first', function () {
                var oldIssueTitles;
                beforeEach(function (done) {
                    oldIssueTitles = _.pluck(project.issues, 'title');
                    project.updateIssuePriority(project.issues[2]._id, 0, ew(function () { reFindProject(done); }));
                });
